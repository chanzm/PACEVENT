            ...
            <span class="text-danger"><?php echo form_error('password'); ?></span>
                  ...
                  <select class="form-control" name="role">
					...
					<div class="container-login100-form-btn">
		 				 <button style="background-color: #800000;" class="login100-form-btn" type="submit" name="insert">Login </button>
					</div>
				</form>

				<div class="login100-more" style="background-image: url(<?php echo base_url(); ?>assets/img/loginhehe.png)">
				</div>
			</div>
		</div>
	</div>
