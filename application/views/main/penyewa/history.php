    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table table-hover" id="example2" width="100%" cellspacing="0">
              ...
              <input type="hidden" class="form-control" name="nominal" value="<?php echo $a->total_bayar?>">
            </div>
             <div class="form-group">
              <input type="hidden" class="form-control" name="nama_ven" value="<?php echo $a->nama_ven?>">
            </div>
