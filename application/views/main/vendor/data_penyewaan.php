            ...
            <table class="table table-hover" id="example2" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php 
                        if($a->status=='DIKONFIRMASI' || $a->status=='SUDAH DIBAYAR' ){
                            echo '<td>';
                            echo anchor('main/dashboard_ven/detail_pesanan_konfirmasi/'.$a->id_sewa,'<button class="btn btn-sm btn-primary">Detail</button>');
                            '</td>';
                        }
