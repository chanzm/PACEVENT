...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
   <title>PACEVENT | <?php echo $this->session->userdata('id_user')->role; ?></title>
...
<div class="wrapper">
  ...
  <?php if($this->session->userdata('id_user')->role == "vendor"){
    ...
    else if($this->session->userdata('id_user')->role== "penyewa"){
 ...
 <div class="modal-header">
            <h3 class="modal-title">Tunggu Konfirmasi Admin ya ! </h3>
          </div>
 <h3> Silahkan tunggu notifikasi konfirmasi dari admin.
 <br>Setelah permintaan dikonfirmasi, uang akan dikirim oleh administrator ke nomor rekening yang sudah dimasukkan.
<br> Jika ada pertanyaan silahkan hubungi administrator di Official Account : </h3>
