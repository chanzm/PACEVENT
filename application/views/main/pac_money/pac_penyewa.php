...
<div class="wrapper">
 ...
 <div class="modal-header">
            <h4 class="modal-title">PAC MONEY Penyewa</h4>
          </div>
 <?php foreach ($penyewa as $user): ?> 
    ...
    <div class="form-group">
      <label>Nama :</label>
        <?php echo $user->nama_peny?>
    </div>
    <div class="form-group">
      <label>Jumlah PAC Money:</label>
        <?php echo $user->pacmoney?>
    </div>
    <form action="<?php echo base_url(). 'main/pac_money_peny/pac_cair/'.$user->id_user?>">
      <button class="btn btn-sm btn-danger">Cairkan PAC Money</button>
    </form>
<?php endforeach; ?>
   </center>
